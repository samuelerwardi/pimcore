...
class DefaultService implements IVoucherService
{
    ...
    /**
     * @param OnlineShopVoucherSeries $series
     *
     * @return bool
     */
    public function cleanUpVoucherSeries(OnlineShopVoucherSeries $series)
    {
    ...
    public function getTokenManager($code)
    {
        if ($token = Token::getByCode($code)) {
            if ($series = OnlineShopVoucherSeries::getById($token->getVoucherSeriesId())) {
